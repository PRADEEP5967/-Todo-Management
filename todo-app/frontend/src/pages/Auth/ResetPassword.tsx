...
const ResetPassword: React.FC = () => {
  ...
  if (!authContext) {
    throw new Error('ResetPassword must be used within an AuthProvider');
  }
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transition-all duration-300 hover:shadow-2xl">
          {success ? (
            <div className="text-center">
              ...
              <h3 className="mt-4 text-xl font-medium text-gray-900 dark:text-white">Password reset successful!</h3>
